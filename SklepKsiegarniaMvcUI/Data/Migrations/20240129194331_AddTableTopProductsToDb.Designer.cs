...
namespace SklepKsiegarniaMvcUI.Data.Migrations
{
    ...
    [Migration("20240129194331_AddTableTopProductsToDb")]
    partial class AddTableTopProductsToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SklepKsiegarniaMvcUI.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SklepKsiegarniaMvcUI.Models.Book", b =>
                {
                    b.HasOne("SklepKsiegarniaMvcUI.Models.Genre", "Genre")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("SklepKsiegarniaMvcUI.Models.CartDetail", b =>
                {
                    b.HasOne("SklepKsiegarniaMvcUI.Models.Book", "Book")
                        .WithMany("CartDetail")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SklepKsiegarniaMvcUI.Models.ShoppingCart", "ShoppingCart")
            ...
            modelBuilder.Entity("SklepKsiegarniaMvcUI.Models.Order", b =>
                {
                    b.HasOne("SklepKsiegarniaMvcUI.Models.OrderStatus", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("SklepKsiegarniaMvcUI.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("SklepKsiegarniaMvcUI.Models.Order", "Order")
                        .WithMany("OrderDetail")
